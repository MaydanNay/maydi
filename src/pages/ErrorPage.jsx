...
export default function ErrorPage() {
  ...
  return (
    <div className="content-above-grid relative flex min-h-[100svh] flex-col items-center justify-center bg-[var(--color-bg-0)] px-[var(--space-3)] pt-16 text-center md:px-[var(--space-6)]">
      ...
      <h1 className="mt-[var(--space-4)] text-[clamp(56px,14vw,112px)] font-semibold leading-none tracking-[-0.02em] text-[var(--color-white)]">
        {t('error.code')}
      </h1>
      <p className="mt-[var(--space-4)] max-w-md text-[clamp(15px,1.8vw,18px)] leading-relaxed text-[var(--color-muted)]">
        {t('error.text')}
      </p>
      <Link
        to="/"
